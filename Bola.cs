...
public class Bola : MonoBehaviour
{
    ...
    //clips de audio
    public AudioClip audioGol, audioRaqueta, audioRebote, audioGoo, audioAplausos;
    ...
    public void reiniciarBola(string direccion)
    {
        ...
        if (direccion == "Derecha")
        {
            ...
            if(golesDerecha == 5)
            {
                //Victoria.Text = "El Ganador es el de la derecha";
                fuenteDeAudio.clip = audioAplausos;
                fuenteDeAudio.Play();
            ...
            if(golesIzquierda == 5)
            {
                ...
                fuenteDeAudio.Play();
                GetComponent<Rigidbody2D>().velocity = Vector2.right * 0;
                //Ganador.Text = "El Ganador es el de la Izquierda";
